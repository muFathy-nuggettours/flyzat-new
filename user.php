<style>
	...
	.admin-message {
		...
		/* Aligns to the end side based on text direction */
	}
</style>
...
$user_pages = array(
	...
	"user-requests" => array(readLanguage(user, reqs), "user_requests", "fas fa-question-circle disabled"),
);

//Check if page exists
if ($get["page"] and !$user_pages[$get["page"]]) {
	brokenLink();
}
