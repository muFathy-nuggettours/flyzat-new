...
<div class=module_search_history>
	...
	<div id=swiper-container-history class=swiper>
		<div class=swiper-wrapper>
			<? foreach ($search_history AS $key=>$value){ ?>
			<div class=swiper-slide>
				<a id="flight_id" class="block <?=($key==0 ? "last" : "previous")?>" href="flights/?<?=http_build_query($value)?>">
...
@media (max-width: 767px) {
	...
	#swiper-container-history .dates,
	#swiper-container-history .dates + small {
		display: none;
	}
	#flight_id {
		padding: 5px;
